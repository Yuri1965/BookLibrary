...
/**
 * Class for processing of the showSetWorkOrderForm team
 */
public class ShowSetWorkOrderForm implements ICommand {
    private Logger logger = LogManager.getLogger(ShowSetWorkOrderForm.class.getName());
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int freeBookCount = DataManager.getCountFreeBook(userOrder.getBookID());

            session.setAttribute("currentTab", "workOrders");
            session.setAttribute("orderSelected", userOrder);
            session.setAttribute("freeBookCount", freeBookCount);
