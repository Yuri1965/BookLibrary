...
/**
 * Class for processing of the showCreateOrderForm team
 */
public class ShowCreateOrderForm implements ICommand {
    private Logger logger = LogManager.getLogger(ShowCreateOrderForm.class.getName());
